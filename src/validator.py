class DataValidator:
    ...
    def check_k_anonymity(self, quasi_identifiers, k=10):
    ...
    def check_l_diversity(self, quasi_identifiers, sensitive_attribute, l=3):
    ...
    def check_t_closeness(self, quasi_identifiers, sensitive_attribute, original_df, t=0.3):
